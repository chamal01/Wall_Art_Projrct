...
$ppicpath="admin/functions/profilepics"."/".$profilepic;
...
<head>
    ...
    <title>Our Products | Sandaru Wall Art Studio</title>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/fancybox/3.5.7/jquery.fancybox.min.js"></script>
    ...
    .panel-body:hover .buy-button,
    .panel-body:hover .cart-button {
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-lg-5">
                    <div class="intro-excerpt">
                        <h1><span class="d-block">Explore Our Wall Art</span></h1>
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <div class="text-center">
                <h6><b>#</b> <?php echo $row['Address']; ?></h6>
            </div>
            <a data-fancybox="gallery" data-caption="<?php echo $row['FirstName'] . ' ' . $row['LastName']; ?>" href="admin/functions/profilepics/<?php echo $row['ProfilePic']; ?>">
                <div class="product-image">
                    <img src="admin/functions/profilepics/<?php echo $row['ProfilePic']; ?>" class="img-responsive" alt="Profile Picture">
                </div>
            </a>
            <div class="product-details">
                <h4><?php echo $row['FirstName'] . ' ' . $row['LastName']; ?></h4>
                <h5><?php echo $row['Description']; ?></h5>
                <h6><span>Price: </span><b>$<?php echo $row['MobileNumber']; ?></b></h6>
            </div>
            <div class="product-footer">
            <button data-product-id="<?php echo $row['ID']; ?>" class="btn btn-primary btn-sm buy-button">
    <span class="glyphicon glyphicon-shopping-cart"></span> Buy
</button>
<button data-product-id="<?php echo $row['ID']; ?>" class="btn btn-primary btn-sm cart-button">
    <span class="glyphicon glyphicon-plus"></span> <i class="fa-solid fa-cart-plus"></i>
</button>
            </div>
        </div>
    </div>
...
<script>
    $(document).ready(function () {
        $('[data-product-id]').on('click', function (e) {
            e.preventDefault(); 
            var productID = $(this).data('product-id');
            $.ajax({
                type: 'POST', 
                url: 'add_cart.php?id=' + productID, 
