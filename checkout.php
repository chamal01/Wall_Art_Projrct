...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <br><br><br><br>
<div class="container">
<form method="POST" action="orders/customer_details.php">
  <div class="col-md-6">
    <label for="inputEmail4" class="form-label">Full Name</label>
    <input type="text" class="form-control" name="OrderName" placeholder="Ex-: A.B.Anderson" required>
  </div>
  <div class="col-md-6">
    <label for="inputPassword4" class="form-label">Closses City</label>
    <input type="text" class="form-control" name="OrderCity" placeholder="Colombo" required>
  </div>
  <div class="col-md-6">
    <label for="inputPassword4" class="form-label">Closses District</label>
    <input type="text" class="form-control" name="OrderDistrict" placeholder="Gampaha" required>
  </div>
  <div class="col-md-6">
    <label for="inputPassword4" class="form-label">Street Address</label>
    <input type="text" class="form-control" name="OrderSTaddress" placeholder="Park Avenue" required>
  </div>
  <div class="col-md-6">
    <label for="inputAddress" class="form-label">Address</label>
    <input type="text" class="form-control" name="OrderAddress" placeholder="1234 Main St" required>
  </div>
  <div class="col-md-6">
    <label for="inputCity" class="form-label">Email</label>
    <input type="email" class="form-control" name="OrderEmail" placeholder="YourEmail@example.com" required>
    <div class="invalid-feedback">Please enter a valid email address.</div>
</div>
<div class="col-md-2">
    <label for="inputZip" class="form-label">Mobile number</label>
    <input type="tel" class="form-control" name="OrderMNumber" placeholder="0771234569" required
           pattern="[0-9]{10}">
                                ...
                                if(!empty($_SESSION['cart'])){
                                    ...
                                    while($row = $query->fetch_assoc()){
                                        ...
                                        <tr>
                                            ...
                                            <td><span>$ </span><?php echo number_format($_SESSION['qty_array'][$index]*$row['MobileNumber'], 2); ?></td>
                                    ...
                                    ?>
                                    <tr>
                                        <td colspan="4" class="text-center">Please select any items from the product page.</td>
                                    </tr>
                                    <?php
                                }
                            ?>
